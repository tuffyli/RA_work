...
# ----------------------------------------------------- #
#Extração da banda ótima 2° Grau
bw_main_p  <- list[["2019-2018P|NF"]]$bws[1]
bw_bias_p  <- list[["2019-2018P|NF"]]$bws[2]

#Salvando a banda principal
save(bw_main_p, bw_bias_p,
     file = "Z:/Tuffy/Paper - HV/Resultados/bandwidths_2019_2018_p2.RData")
# ----------------------------------------------------- #
...
### 1.1.5 Pol Horário + cont ----
list[[as.character(paste0(2019,"-",2018,"P3|NF"))]] <- rdrobust(
  y = base_a$d.media[base_a$ano == 2019],
  x = base_a$dist_hv_border[base_a$ano == 2018],
  c = 0,
  p = 2, 
...
#TC Pol 2° Grau - FUSO
result$pohv[1] <- t10$coef[[4]]
result$pohv[2] <- t10$se[[4]]
result$pohv[3] <- t10$N[[4]]


#TC Pol 2° Grau - FUSO + Cont
result$pohc[1] <- t10$coef[[5]]
result$pohc[2] <- t10$se[[5]]
result$pohc[3] <- t10$N[[5]]
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/DIFF_Principal_TC_v2.tex")
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/OLDER_vs_young_v2.tex")
...
ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/RDD_Principal_1918_v3.png"),plot = fig_gg, device = "png",dpi = 300, height = 6, width = 9)
ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/pdf/RDD_Principal_1918_v3.pdf"),plot = fig_gg, device = "pdf",height = 10, width = 13)
...
ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/RDD_Principal_1817_v3.png"),plot = fig_gg, device = "png",dpi = 300, height = 6, width = 9)
ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/pdf/RDD_Principal_1817_v3.pdf"),plot = fig_gg, device = "pdf",height = 7, width = 10)
...
for (i in fig_loop) {
  ...
  ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/bins/1_bins_",i,"_pol1_1918_v1.png"),plot = fig_gg, device = "png",dpi = 300, height = 9, width = 11)
  ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/bins/1_bins_",i,"_pol1_1918_v1.pdf"),plot = fig_gg, device = "pdf",height = 9, width = 11)
...
for (i in fig_loop) {
  ...
  ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/bins/1_bins_",i,"_pol2_1918_v1.png"),plot = fig_gg, device = "png",dpi = 300, height = 6, width = 9)
  ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/bins/1_bins_",i,"_pol2_1918_v1.pdf"),plot = fig_gg, device = "pdf",height = 7, width = 10)
...
for (i in fig_loop) {
  ...
  ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/bins/2_bins_",i,"_pol1_1917_v1.png"),plot = fig_gg, device = "png",dpi = 300, height = 6, width = 9)
  ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/bins/2_bins_",i,"_pol1_1917_v1.pdf"),plot = fig_gg, device = "pdf",height = 7, width = 10)
...
for (i in fig_loop) {
  ...
  ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/bins/2_bins_",i,"_pol4_1917_v1.png"),plot = fig_gg, device = "png",dpi = 300, height = 9, width = 11)
  ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/bins/2_bins_",i,"_pol4_1917_v1.pdf"),plot = fig_gg, device = "pdf",height = 9, width = 11)
...
for (i in fig_loop) {
  ...
  ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/bins/3_bins_",i,"_pol2_1817_v1.png"),plot = fig_gg, device = "png",dpi = 300, height = 6, width = 9)
  ggsave(filename = paste0("Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/img/bins/3_bins_",i,"_pol2_1817_v1.pdf"),plot = fig_gg, device = "pdf",height = 7, width = 10)
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/pol2/Materias_v1.tex")
