...
### Main 
list[[as.character(paste0(2019,"-",2018,"main_esc"))]] <- rdrobust(
...
list[[as.character(paste0(2019,"-",2018,"|escfuso"))]] <- rdrobust(
  y = base_esc$d.media[base_esc$ano == 2019],
  x = base_esc$dist_hv_esc[base_esc$ano == 2018],
  c = 0,
  cluster = base_esc$seg_esc[base_esc$ano == 2018],
...
list[[as.character(paste0(2019,"-",2018,"|escpol+fuso+C"))]] <- rdrobust(
  y = base_esc$d.media[base_esc$ano == 2019],
  x = base_esc$dist_hv_esc[base_esc$ano == 2018],
  c = 0,
  p = 2, 
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/robust_vars.tex")
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/Materias_v1.tex")
#5548
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/Redacao_v1.tex")
#5548
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/Dificuldade_v1.tex")
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/Dificuldade_mae.tex")
#0 = 5465, 1 = 5433
rm( mat_nota, result, latex_table)


# ---------------------------------------------------------------------------- #
## 5.4 Difficulty Simple ----
# ---------------------------------------------------------------------------- #
# ---------------------------------------------------------------------------- #
### 5.4.1 Regression ----
# ---------------------------------------------------------------------------- #
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/Dificuldade_simple_v1.tex")
# N = Total 5540. Por mate 5548
rm(dif_list, dif_tab, mat_nota, result, rp_list, latex_table, d_list)
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/Dias_v1.tex")
#5548
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/Dias_simple_v1.tex")
#5548
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/Abs_Dias_v1.tex")
#N = 5559
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/Raca_v1.tex")
#5417, 5336
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/Sexo_v1.tex")
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/OLDER_vs_young_v1.tex")
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/grupos_mig_v2.tex")
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/fuso_resultado_v1.tex")
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/fuso_resultado_simple_v1.tex")
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/Saeb.tex")
...
for(ano in 2013:2019) { #loop para abertura das bases de dados
  ...
  base_temp <- readRDS(file = paste0("Z:/Tuffy/Paper - HV/Bases/No_age_filt/base_nota_",ano,".RDS")) %>% 
    select( #selecionando apenas as colunas principais
      mun_res, ano, id_enem, hv, priv0, lon, lat, dist_hv_border, seg, media, idade, conclusao
    ) %>% 
    filter(
  ...
  base_nota <- base_temp[priv0 == 1,.(media_nota = mean(media, na.rm = T), #nota média
                         ...
                         by = .(mun_res,ano)] #variáveis de agregação
...
writeLines(latex_table, "Z:/Tuffy/Paper - HV/Resultados/definitive/final/comp_amostras_v1.tex")
