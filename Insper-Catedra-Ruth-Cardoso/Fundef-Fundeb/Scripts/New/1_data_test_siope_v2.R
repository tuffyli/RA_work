...
PATH_INTERMEDIATE <- file.path(PATH_TUFFY, "Dados/intermediate")
PATH_IFB      <- "Z:/Arquivos IFB"                      # Raw public microdata
PATH_BRASIL   <- "Z:/Tuffy/Paper - Brasil"              # Companion paper folder

# Shared SIOPE cache used by all scripts
PATH_SIOPE_ROOT <- file.path(PATH_TUFFY, "Dados/SIOPE")
PATH_SIOPE_RAW  <- file.path(PATH_SIOPE_ROOT, "raw")
PATH_SIOPE_AN   <- file.path(PATH_SIOPE_ROOT, "Anos")
...
saveRDS(df, file.path(PATH_INTERMEDIATE, "fundef_fundeb_2000_2001.rds"))
...
saveRDS(df, file.path(PATH_INTERMEDIATE, "defla_fundef_fundeb_2000_2001.rds"))
...
write.csv2(
  ...
  file.path(
    PATH_INTERMEDIATE,
    "painel_notas_transferencias_2000_2024.csv"
  ),
  row.names = FALSE
)
...
# Once files are written to PATH_SIOPE_RAW/, set it back to FALSE.
# ---------------------------------------------------------------------------- #
...
# given year into one consolidated file saved under PATH_SIOPE_AN/.
...
# Reads the pre-built annual CSVs from PATH_SIOPE_AN/ and applies year-specific
...
# ipca <- read_excel(file.path(PATH_TUFFY, "Dados/IPCA_acumulado_ano.xlsx"), skip = 1)
...
saveRDS(mat_2006, file.path(PATH_INTERMEDIATE, "censo_2006_filtrado.rds"))
mat_2006 <- readRDS(file.path(PATH_INTERMEDIATE, "censo_2006_filtrado.rds"))
...
saveRDS(mat_2006_munic, file.path(PATH_INTERMEDIATE, "censo_2006_filtrado_mun.rds"))
...
mat_2006 <- readRDS(file.path(PATH_INTERMEDIATE, "censo_2006_filtrado_mun.rds")) %>%
...
df_simulation_2007 <- readRDS(
  file.path(PATH_INTERMEDIATE, "expected_2007_fundef_value.RDS")
)
...
saveRDS(simulacao, file.path(PATH_INTERMEDIATE, "simulacao_const.rds"))
...
df_sim <- readRDS(file.path(PATH_INTERMEDIATE, "simulacao_const.rds"))
...
saveRDS(pib_final, file.path(PATH_INTERMEDIATE, "final_pib.rds"))
...
mat_mun_2006 <- readRDS(file.path(PATH_INTERMEDIATE, "censo_2006_filtrado_mun.rds")) %>%
...
pib_final <- readRDS(file.path(PATH_INTERMEDIATE, "final_pib.rds"))
